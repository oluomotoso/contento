...
<head>
    ...
    <link rel="stylesheet" href="{{asset('member/datatables/css/dataTables.bootstrap.min.css?v2.2.0')}}">
    <link rel="stylesheet" href="{{asset('member/datatables/css/dataTables.fixedHeader.min.css?v2.2.0')}}">
    <link rel="stylesheet" href="{{asset('member/datatables/css/dataTables.responsive.min.css?v2.2.0')}}">

    <!-- Page -->
    <link rel="stylesheet" href="{{asset('member/datatables/css/datatable.min.css?v2.2.0')}}">
...
<!-- Fonts -->
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-55NRNQ4');</script>
    <!-- End Google Tag Manager -->
</head>
<body class="dashboard site-navbar-small">
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55NRNQ4"
...
<footer class="site-footer">
    <div class="site-footer-legal">© {{date('Y')}} <a
                href="http://www.loftysms.com">Loftysms.com</a>
    </div>
...
<script src="{{asset('member/datatables/js/dataTables.fixedHeader.js')}}"></script>
<script src="{{asset('member/datatables/js/dataTables.bootstrap.min.js')}}"></script>
<script src="{{asset('member/datatables/js/dataTables.responsive.js')}}"></script>
<script src="{{asset('member/datatables/js/dataTables.tableTools.js')}}"></script>
<script src="{{asset('member/datatables/js/jquery-asRange.min.js')}}"></script>
<script src="{{asset('member/datatables/js/bootbox.js')}}"></script>
...
<script src="{{asset('member/datatables/js/datatables.min.js')}}"></script>
<script src="{{asset('member/datatables/js/icon.min.js')}}"></script>
