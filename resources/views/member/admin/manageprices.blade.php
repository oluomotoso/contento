                    ...
                    <form id="form" action="{{url('/admin/manage-sources')}}" class="form-horizontal" method="post">
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Create Price</h2>
                            </header>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control"
                                               placeholder="Name of the Price"
                                               value="{{old('name')}}"
                                               required/>
                                    </div>
                                </div> <div class="form-group">
                                    <label class="col-sm-3 control-label">Price (USD)<span
                                                class="required">*</span></label>

                                    <div class="col-sm-9">
                                        <input type="number" name="price" class="form-control"
                                               placeholder="Price of the Plan in USD"
                                               value="{{old('price')}}"
                                               required/>
                                    </div>
                                </div> <div class="form-group">
