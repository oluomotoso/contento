...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <article id="intro">
            ...
            <span class="image main"><img src="{{asset('front/images/pic01.jpg')}}" alt=""/></span>
        ...
        <article id="work">
            ...
            <span class="image main"><img src="{{asset('front/images/pic02.jpg')}}" alt=""/></span>
        ...
        <article id="about">
            ...
            <span class="image main"><img src="{{asset('front/images/pic03.jpg')}}" alt=""/></span>
